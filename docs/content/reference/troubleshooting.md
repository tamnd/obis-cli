...
Most of these come down to network reality or how obis serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

obis rate-limits like any public site. obis already paces
...
Where a surface is gated, obis reads a cookie or token you supply
...
`obis`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what obis actually did
